...
// document.addEventListener("DOMContentLoaded", function() {
//     // Simular una visita anterior para pruebas: ajusta este valor según sea necesario
//     var simulateLastVisitDaysAgo = 3; // Cambia el número de días para simular diferentes escenarios
//     var simulatedLastVisit = new Date();
//     simulatedLastVisit.setDate(simulatedLastVisit.getDate() - simulateLastVisitDaysAgo);
//     localStorage.setItem("lastVisit", simulatedLastVisit.getTime());
